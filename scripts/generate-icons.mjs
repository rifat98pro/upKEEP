...
const lockup = join(root, 'assets', 'logo-mark-transparent.png');
...
/*
 * The transparent cut, so a favicon on a light browser tab is the mark rather
 * than a black square containing the mark. Generated by logo-transparent.mjs.
 */
const symbol = join(root, 'assets', 'logo-mark-transparent.png');
